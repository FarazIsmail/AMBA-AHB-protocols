        ...
        if (!HRESETn) begin
            ...
            if (next_state == READ) begin
                if ((HBURST == 3'b000 || HBURST == 3'b001)) begin
                    case (HSIZE)
                        3'b000: begin
                            HRDATA <= {24'h000000, memory_2[HADDR[29:0]]};
                        end
                        3'b001: begin
                            HRDATA <= {16'h0000, memory_2[HADDR_Half], memory_2[HADDR[29:0]]};
                        end
                        3'b010: begin
                            HRDATA <= {memory_2[HADDR_Full_3], memory_2[HADDR_Full_2], memory_2[HADDR_Full_1], memory_2[HADDR[29:0]]};
                        end
                    endcase
                end
            end
