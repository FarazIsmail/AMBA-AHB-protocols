module AHB_Slave_1 #(
    parameter MEM_WIDTH = 8 , parameter MEM_DEPTH = 1024  
) (
    input HCLK,
    input HRESETn,
    input [31:0] HADDR,
    ...
    always @(posedge HCLK or negedge HRESETn) begin
        if (!HRESETn) begin
        ...
        else if (!HSELx_slaves && HREADY) begin
            ...
            if (HWRITE_reg && (HTRANS_reg == 2'b10 || HTRANS_reg == 2'b11)) begin
                ...
                else if ((HBURST == 3'b000 || HBURST == 3'b001) && HSIZE == 3'b001) begin
                    HRDATA <= {16'h0000, memory[HADDR_Half], memory[HADDR[29:0]]};
                end 
                else if ((HBURST == 3'b000 || HBURST == 3'b001) && HSIZE == 3'b010)  begin
